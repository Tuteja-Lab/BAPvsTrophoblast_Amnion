...
file2 <-
  "~/TutejaLab/amnion_for_ms_20210715/heatmaps.v2/Fig6b_and_monkeygenes/genes-monkey.txt"
monkey <-
  read.csv(file2,
           sep = "\t",
           header = TRUE,
...
```{r cor1a, fig.cap="Fig 4.1B: Corelation plot for the new amnion marker genes", fig.width=8, fig.height=8}
...
```{r cor1b, fig.cap="Fig 4.2B: Corelation plot for the Io amnion marker genes", fig.width=8, fig.height=8}
...
## Visulaization (new Amnion marker genes) for amnion and organoid datasets
...
```{r cor1c, fig.cap="Fig 4.3B: Corelation plot for the new amnion marker genes", fig.width=8, fig.height=8}
...
## Visulaization (old Amnion marker genes) for amnion and organoid datasets
...
```{r cor1d, fig.cap="Fig 4.4B: Corelation plot for the Io amnion marker genes", fig.width=8, fig.height=8}
