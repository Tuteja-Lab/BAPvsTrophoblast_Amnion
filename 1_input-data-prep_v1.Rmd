...
Using the `srr-to-labels.txt` file, the SRR numbers in the master coutns file were converted to informative names. From this master counts table, subset datasets were derived using the cut command.
