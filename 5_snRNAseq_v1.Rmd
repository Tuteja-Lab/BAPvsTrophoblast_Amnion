...
### Visulaize dimensional reduction
...
```{r clusterplotsInteractive, fig.cap="Fig 5.13: Interactive Dimensional reduction plot cells plotted in two dimensions. The colored dots represent individual cells and are assigned based on cluster identity", fig.width=6, fig.height=5}
A = enhancedDimPlot(
  object = bapd8.integrated,
  grouping_var = 'ident',
  reduction = "umap",
...
Cluster markers are defined as FC of >= 1 and p-value (adj) <= 0.05.
